...
#  define TS_DEPRECATED(message) __declspec(deprecated(message))
#  define TS_CALL __stdcall
#elif defined(__GNUC__) || defined(__clang__)
#  define TS_API_EXPORT __attribute__((visibility("default")))
#  define TS_API_IMPORT
#  define TS_DEPRECATED(message) __attribute__((deprecated(message)))
#  define TS_CALL
#else
#  define TS_API_EXPORT
#  define TS_API_IMPORT
#  define TS_DEPRECATED(message)
#  define TS_CALL
#endif

#define TS_API_DEPRECATED(message) TS_API TS_DEPRECATED(message)
...
/*!
    \brief Skeleton Biomechanical index
*/
typedef enum TsBiomechanicalIndex
{
    TsBiomechanicalIndex_PelvisTilt = 0,
    TsBiomechanicalIndex_PelvisList = 1,
    TsBiomechanicalIndex_PelvisRotation = 2,
    TsBiomechanicalIndex_HipFlexExtR = 3,
    TsBiomechanicalIndex_HipAddAbdR = 4,
    TsBiomechanicalIndex_HipRotR = 5,
    TsBiomechanicalIndex_KneeFlexExtR = 6,
    TsBiomechanicalIndex_AnkleFlexExtR = 7,
    TsBiomechanicalIndex_AnkleProSupR = 8,
    TsBiomechanicalIndex_HipFlexExtL = 9,
    TsBiomechanicalIndex_HipAddAbdL = 10,
    TsBiomechanicalIndex_HipRotL = 11,
    TsBiomechanicalIndex_KneeFlexExtL = 12,
    TsBiomechanicalIndex_AnkleFlexExtL = 13,
    TsBiomechanicalIndex_AnkleProSupL = 14,
    TsBiomechanicalIndex_ElbowFlexExtR = 15,
    TsBiomechanicalIndex_ForearmProSupR = 16,
    TsBiomechanicalIndex_WristFlexExtR = 17,
    TsBiomechanicalIndex_WristDeviationR = 18,
    TsBiomechanicalIndex_ElbowFlexExtL = 19,
    TsBiomechanicalIndex_ForearmProSupL = 20,
    TsBiomechanicalIndex_WristFlexExtL = 21,
    TsBiomechanicalIndex_WristDeviationL = 22,
    TsBiomechanicalIndex_ShoulderAddAbdR = 36,
    TsBiomechanicalIndex_ShoulderRotR = 37,
    TsBiomechanicalIndex_ShoulderFlexExtR = 38,
    TsBiomechanicalIndex_ShoulderAddAbdL = 39,
    TsBiomechanicalIndex_ShoulderRotL = 40,
    TsBiomechanicalIndex_ShoulderFlexExtL = 41
